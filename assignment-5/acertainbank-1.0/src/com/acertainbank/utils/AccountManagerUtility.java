...
import com.acertainbank.client.BookStoreClientConstants;
 ...
 *
 */
public final class AccountManagerUtility {
    ...
    public static int convertStringToInt(String str) throws Exception {
        ...
        try {
            ...
            throw new AccountManagerException(ex);
        }
        return returnValue;
    }
     ...
     * @return
     */
    public static AccountManagerMessageTag convertURItoMessageTag(String requestURI) {

        try {
            AccountManagerMessageTag messageTag = AccountManagerMessageTag
